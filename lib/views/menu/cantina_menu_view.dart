    ...
    return Scaffold(
      ...
      body: menuViewModel.isLoading
        ...
        itemBuilder: (context, index) {
          ...
          return Card( // <<< Usar um Card para dar um visual de "cartão"
            elevation: 2.0, // Sombra
            margin: EdgeInsets.symmetric(horizontal: 8.0, vertical: 4.0), // Margem entre cartões
            child: Padding( // Espaçamento interno
              padding: const EdgeInsets.all(8.0),
              child: Row( // Usar Row para organizar imagem à esquerda e detalhes à direita
                crossAxisAlignment: CrossAxisAlignment.start, // Alinha o conteúdo no topo
                children: [
                  // Imagem do Item
                  ClipRRect( // Cortar a imagem com bordas arredondadas (opcional)
                  ...
                  SizedBox(width: 12.0), // Espaço entre a imagem e os detalhes

                  // Detalhes do Item (Nome, Descrição, Preço)
                  Expanded( // Expande para ocupar o espaço restante na Row
                    child: Column( // Usar Column para empilhar nome, descrição e preço
                      ...
                      children: [
                        Text(
                          ...
                          overflow: TextOverflow.ellipsis, // Adicionar "..." se o texto for longo
                        ),
                        SizedBox(height: 4.0), // Espaço entre nome e descrição
                        Text(
                        ...
                        SizedBox(height: 8.0), // Espaço entre descrição e preço
                        Text(
                  ...
                  SizedBox(width: 12.0), // Espaço entre detalhes e botão de compra

                  // Botão de Adicionar ao Carrinho
                  Align( // Alinhar o ícone no topo (opcional, já está pelo crossAxisAlignment.start da Row)
